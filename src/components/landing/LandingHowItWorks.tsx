...
const Text = () => {
  ...
  return (
    <div ref={containerRef} className="relative z-10 h-full w-full bg-transparent flex flex-col justify-between px-10 md:px-12 md:py-10 lg:max-w-7xl tracking-wider">
